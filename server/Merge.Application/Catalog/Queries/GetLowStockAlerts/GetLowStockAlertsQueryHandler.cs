...
public class GetLowStockAlertsQueryHandler : IRequestHandler<GetLowStockAlertsQuery, PagedResult<LowStockAlertDto>>
{
    ...
    {
        _logger.LogInformation("Retrieving low stock alerts by UserId: {UserId}. WarehouseId: {WarehouseId}, Page: {Page}, PageSize: {PageSize}",
        ...
        var cachedResult = await _cache.GetOrCreateAsync(
            ...
            async () =>
            {
                _logger.LogInformation("Cache miss for low stock alerts. UserId: {UserId}, WarehouseId: {WarehouseId}, Page: {Page}, PageSize: {PageSize}",
                ...
                _logger.LogInformation("Retrieved {Count} low stock alerts (page {Page})", lowStockItems.Count, page);
