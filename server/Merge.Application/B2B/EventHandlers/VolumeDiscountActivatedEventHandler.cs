...
/// </summary>
public class VolumeDiscountActivatedEventHandler : INotificationHandler<VolumeDiscountActivatedEvent>
{
    private readonly ILogger<VolumeDiscountActivatedEventHandler> _logger;

    public VolumeDiscountActivatedEventHandler(ILogger<VolumeDiscountActivatedEventHandler> logger)
    {
        _logger = logger;
    }
