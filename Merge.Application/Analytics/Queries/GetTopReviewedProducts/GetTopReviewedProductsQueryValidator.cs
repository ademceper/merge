...
public class GetTopReviewedProductsQueryValidator : AbstractValidator<GetTopReviewedProductsQuery>
{
    public GetTopReviewedProductsQueryValidator(IOptions<PaginationSettings> paginationSettings)
    {
