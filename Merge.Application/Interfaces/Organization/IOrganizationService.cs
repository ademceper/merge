...
public interface IOrganizationService
{
    ...
    Task<PagedResult<OrganizationDto>> GetAllOrganizationsAsync(string? status = null, int page = 1, int pageSize = 0, CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<TeamDto>> GetOrganizationTeamsAsync(Guid organizationId, bool? isActive = null, int page = 1, int pageSize = 0, CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<TeamMemberDto>> GetTeamMembersAsync(Guid teamId, bool? isActive = null, int page = 1, int pageSize = 0, CancellationToken cancellationToken = default);
    Task<PagedResult<TeamDto>> GetUserTeamsAsync(Guid userId, int page = 1, int pageSize = 0, CancellationToken cancellationToken = default);
}
