...
public interface ILandingPageService
{
    ...
    Task<LandingPageDto> CreateLandingPageAsync(Guid? authorId, object dto, CancellationToken cancellationToken = default);
    ...
    Task<bool> UpdateLandingPageAsync(Guid id, object dto, CancellationToken cancellationToken = default);
    ...
    [Obsolete("Use CreateLandingPageCommand via MediatR instead")]
    Task<LandingPageDto> CreateVariantAsync(Guid originalId, object dto, CancellationToken cancellationToken = default);
