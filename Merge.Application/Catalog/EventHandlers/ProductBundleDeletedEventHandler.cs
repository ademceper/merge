...
/// </summary>
public class ProductBundleDeletedEventHandler : INotificationHandler<ProductBundleDeletedEvent>
{
    private readonly ILogger<ProductBundleDeletedEventHandler> _logger;

    public ProductBundleDeletedEventHandler(ILogger<ProductBundleDeletedEventHandler> logger)
    {
        _logger = logger;
    }
