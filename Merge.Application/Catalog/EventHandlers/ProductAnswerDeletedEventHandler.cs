...
/// </summary>
public class ProductAnswerDeletedEventHandler : INotificationHandler<ProductAnswerDeletedEvent>
{
    private readonly ILogger<ProductAnswerDeletedEventHandler> _logger;

    public ProductAnswerDeletedEventHandler(ILogger<ProductAnswerDeletedEventHandler> logger)
    {
        _logger = logger;
    }
