...
/// </summary>
public class PreOrderCampaignCreatedEventHandler : INotificationHandler<PreOrderCampaignCreatedEvent>
{
    private readonly ILogger<PreOrderCampaignCreatedEventHandler> _logger;

    public PreOrderCampaignCreatedEventHandler(ILogger<PreOrderCampaignCreatedEventHandler> logger)
    {
        _logger = logger;
    }
