...
public class GetProductWholesalePricesQueryValidator : AbstractValidator<GetProductWholesalePricesQuery>
{
    public GetProductWholesalePricesQueryValidator(IOptions<PaginationSettings> paginationSettings)
    {
