...
/// </summary>
public class ShippingAddressSetAsDefaultEventHandler : INotificationHandler<ShippingAddressSetAsDefaultEvent>
{
    private readonly ILogger<ShippingAddressSetAsDefaultEventHandler> _logger;

    public ShippingAddressSetAsDefaultEventHandler(ILogger<ShippingAddressSetAsDefaultEventHandler> logger)
    {
        _logger = logger;
    }
