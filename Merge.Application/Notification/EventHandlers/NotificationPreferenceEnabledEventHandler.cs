...
/// </summary>
public class NotificationPreferenceEnabledEventHandler : INotificationHandler<NotificationPreferenceEnabledEvent>
{
    private readonly ILogger<NotificationPreferenceEnabledEventHandler> _logger;

    public NotificationPreferenceEnabledEventHandler(ILogger<NotificationPreferenceEnabledEventHandler> logger)
    {
        _logger = logger;
    }
