...
/// </summary>
public class PushNotificationSentEventHandler : INotificationHandler<PushNotificationSentEvent>
{
    private readonly ILogger<PushNotificationSentEventHandler> _logger;

    public PushNotificationSentEventHandler(ILogger<PushNotificationSentEventHandler> logger)
    {
        _logger = logger;
    }
