...
public class SearchKnowledgeBaseArticlesQueryHandler : IRequestHandler<SearchKnowledgeBaseArticlesQuery, PagedResult<KnowledgeBaseArticleDto>>
{
    private readonly IDbContext _context;
    private readonly IMapper _mapper;
    private readonly SupportSettings _settings;

    public SearchKnowledgeBaseArticlesQueryHandler(
        IDbContext context,
        IMapper mapper,
