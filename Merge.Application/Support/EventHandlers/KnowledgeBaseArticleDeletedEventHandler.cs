...
/// </summary>
public class KnowledgeBaseArticleDeletedEventHandler : INotificationHandler<KnowledgeBaseArticleDeletedEvent>
{
    private readonly ILogger<KnowledgeBaseArticleDeletedEventHandler> _logger;

    public KnowledgeBaseArticleDeletedEventHandler(ILogger<KnowledgeBaseArticleDeletedEventHandler> logger)
    {
        _logger = logger;
    }
