...
public class B2BController : BaseController
{
    ...
    [RateLimit(MaxRequests = 10, WindowSeconds = 60)] // ✅ BOLUM 3.3: Rate Limiting - 10/dakika (Spam koruması)
    ...
    [Authorize(Roles = "Admin,Manager")]
    [RateLimit(MaxRequests = 20, WindowSeconds = 60)] // ✅ BOLUM 3.3: Rate Limiting - 20/dakika
    ...
    [RateLimit(MaxRequests = 10, WindowSeconds = 3600)] // ✅ BOLUM 3.3: Rate Limiting - 10/saat (Fraud koruması)
